"""
Django settings for CURE QUEST project.
...
ALLOWED_HOSTS = ['192.168.115.37', '127.0.0.1', '5749-103-109-53-5.in.ngrok.io', 'madicx.netlify.app']
...
WSGI_APPLICATION = 'CURE QUEST.wsgi.application'
